...
const Hero = () => {
  ...
  const rotatingWords = ["Marketing", "Contenido", "Contenido",  "Ecomerce", "Branding", "WebAps", "IA", "Publicidad", "TikTok", "Instagram",
    "Facebook", "Influencer"
  ];
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            Asorana agencia digital 360, Acompañamos marcas en su transformación
             digital — desde la identidad visual hasta la adquisición de Clientes y ventas.
          </motion.p>
          ...
          >
            ...
            <div className="text-center text-muted-foreground text-sm font-medium">Empresas y Usuarios que confiaron en nosotros</div>
          </motion.div>
